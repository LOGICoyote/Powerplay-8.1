...
public class BlueParkRR extends LinearOpMode {
...
//                })
                .build();
        TrajectorySequence traj2a = drive.trajectorySequenceBuilder(startPose)
                .strafeLeft(11)
                .build();
        TrajectorySequence traj2b = drive.trajectorySequenceBuilder(startPose)
                .strafeLeft(5)
                .forward(20)
                .build();
        TrajectorySequence traj2c = drive.trajectorySequenceBuilder(startPose)
                .strafeLeft(30)
                .back(3)
                .strafeLeft(30)
                .back(10)
